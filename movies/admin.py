...
class MovieAdminForm(forms.ModelForm):
    ...
    description_ru = forms.CharField(label='Описание фильма', widget=CKEditorUploadingWidget())
    description_en = forms.CharField(label='Описание фильма', widget=CKEditorUploadingWidget())
